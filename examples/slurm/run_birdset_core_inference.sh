...
#   BEANS_PRO_OUT_DIR=/scratch/$USER/results/birdset_core_run \
#   sbatch --dependency=after:$SERVE_JOB_ID examples/slurm/run_birdset_core_inference.sh
#
# Optional overrides:
# - BEANS_PRO_LIMIT=5 (debug)
# - BEANS_PRO_RUN_ID=custom_name
# - BEANS_PRO_ESP_DATA_WORKERS=8
# - BEANS_PRO_INFERENCE_WORKERS=1
...
export BEANS_PRO_SUITE="${BEANS_PRO_SUITE:-birdset_core}"
export BEANS_PRO_DATA_SOURCE="${BEANS_PRO_DATA_SOURCE:-esp_data}"
...
export BEANS_PRO_INFERENCE_WORKERS="${BEANS_PRO_INFERENCE_WORKERS:-1}"
