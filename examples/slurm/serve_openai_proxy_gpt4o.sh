...
PORT="${BEANS_NEXT_PORT:-19085}"

# Job-scoped uv environment on node-local scratch.
export UV_PROJECT_ENVIRONMENT="${BEANS_NEXT_UV_PROJECT_ENVIRONMENT:-/scratch/$USER/venvs/beans-next-openai-proxy-${SLURM_JOB_ID}}"
...
def main() -> int:
    ...
    smoke_timeout = float(os.environ.get("BEANS_NEXT_SMOKE_TIMEOUT_SEC", "120"))
    predict_body = {
